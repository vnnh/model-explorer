...
import { FlyControls as FlyControlsImpl } from "./FlyControlsObject";
export declare type FlyControlsProps = ReactThreeFiber.Object3DNode<FlyControlsImpl, typeof FlyControlsImpl> & {
	onChange?: (e?: THREE.Event) => void;
};
export declare const FlyControls: React.ForwardRefExoticComponent<
	Pick<
		FlyControlsProps,
		| "object"
		| "attach"
		...
		| "autoForward"
	> &
		React.RefAttributes<FlyControlsImpl>
>;
