...
import { NURBSCurve } from "three-stdlib/curves/NURBSCurve.js";
...
class BinaryFBXLoader extends Loader {
	constructor(manager) {
		super(manager);
	}
	...
	load(url, onLoad, onProgress, onError) {
		...
		const scope = this;
		const path = scope.path === "" ? LoaderUtils.extractUrlBase(url.path) : scope.path;

		url.bufferPromise.then(function (buffer) {
			try {
